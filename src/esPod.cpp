...
void esPod::processLingo0x04(const byte *byteArray, uint32_t len)
{
    ...
    else
    {
        ...
        case L0x04_PlayControl: // Basic play control. Used for Prev, pause and play
        {
            ...
            if ((playStatus == PB_STATE_STOPPED) && (playStatusNotificationState == NOTIF_ON))
                L0x04_0x27_PlayStatusNotification(0x00); // Notify successful stop
        }
        break;
...
void esPod::L0x00_0x25_RetiPodOptions()
{
